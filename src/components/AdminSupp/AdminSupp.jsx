...
const documents = [
  {
    id: 1,
    title: "Procedimiento de Compras y Gestión de Proveedores",
    code: "GA-PR-001",
    version: "1.0",
    date: "2025-02-05",
    subprocess: "Compras y Gestión de Proveedores",
    type: "Procedimientos",
    tag: "PR",
    color: "bg-red-600"
  },
  {
    id: 2,
    title: "Procedimiento de Tesorería: Cuentas por Pagar y Pagos",
    code: "GA-PR-002",
    version: "1.1",
    date: "2025-02-18",
    subprocess: "Contratación y Admin de Personal",
    type: "Procedimientos",
    tag: "PR",
    color: "bg-red-600"
  },
  {
    id: 3,
    title: "Política de Presupuesto, Gastos y Aprobaciones",
    code: "GA-PO-001",
    version: "1.0",
    date: "2025-03-01",
    subprocess: "Contratación y Admin de Personal",
  ...
  {
    id: 4,
    title: "Formato de Orden de Compra",
    code: "GA-FO-001",
    version: "1.0",
    date: "2025-02-25",
    subprocess: "Compras y Gestión de Proveedores",
  ...
  {
    id: 5,
    title: "Procedimiento de Contratación y Administración de Personal",
    code: "GA-PR-003",
    version: "1.0",
    date: "2025-03-10",
    subprocess: "Contratación y Admin de Personal",
    ...
    <div className="max-w-7xl mx-auto p-6 bg-white">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Administración de recursos financieros, contables, administrativos y de apoyo logístico de la organización.
        </p>
      </div>
          ...
          {!uploadedPdf ? (
            <div>
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                Caracterización - Proceso de Gestion Administrativa y Financiera
              </h3>
            ...
            <div>
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                Caracterización - Proceso de Gestion Administrativa y FinancieraCentro de Excelencia
              </h3>
              ...
              <p className="text-sm text-gray-500">
                Código: GA-CAR-001 | Versión: 1.0 | Fecha: 2025-03-15 | Subproceso: Gestión Administrativa y Financiera
              </p>
            </div>
          )}
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4 mb-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <option>Compras y Gestión de Proveedores</option>
              <option>Contratación y Admin de Personal </option>
            </select>
          </div>
        </div>
