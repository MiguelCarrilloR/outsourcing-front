...
const SupportMain = () => {
  ...
  const processes = [
    ...
    },
    {
      ...
      path: '/soporte/transformacion' // <-- NUEVO,
    },
    {
      ...
      path: '/soporte/administrativa' // <-- NUEVO
    },
    {
      id: 'Gestion Humana',
