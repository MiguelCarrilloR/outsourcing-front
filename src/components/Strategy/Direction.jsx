...
export default function StrategicDirectionModule() {
  ...
  const documents = [
    {
      id: 1,
      title: "Política de Direccionamiento Estratégico",
      code: "DE-POL-001",
      version: "1.0",
      date: "2024-01-13",
      subprocess: "Planeación Estratégica",
      type: "Políticas",
      tag: "PO",
      color: "bg-red-600"
    },
    {
      id: 2,
      title: "Procedimiento de Planeación Estratégica",
      code: "DE-PRO-001",
      version: "1.4",
      date: "2024-01-29",
      subprocess: "Planeación Estratégica",
    ...
    },
    {
      ...
      version: "2.2",
      date: "2024-02-25",
      subprocess: "Gobierno Corporativo",
    ...
    {
      id: 4,
      title: "Caracterización del Proceso",
      code: "DE-CAR-001",
      version: "1.0",
      date: "2024-03-15",
      subprocess: "Planeación Estratégica",
      type: "Caracterizaciones",
      tag: "CA",
      color: "bg-red-600"
    },
    {
      id: 5,
      title: "Formato de Evaluación Estratégica",
      code: "DE-FOR-001",
      version: "2.1",
      date: "2024-02-10",
      subprocess: "Planeación Estratégica",
  ...
  const esFormato = (doc) => normalizar(doc?.type) === 'formatos' || normalizar(doc?.type) === 'formato';
  ...
  const filteredDocuments = documents.filter(doc => {
    ...
    const matchesType =
      selectedType === 'Todos los tipos' || doc.type === selectedType;
    ...
    <div className="max-w-7xl mx-auto p-6 bg-white">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Definición de la estrategia organizacional, objetivos corporativos y planes de desarrollo.
        </p>
      </div>
          ...
          {!uploadedPdf ? (
            ...
            <div>
              ...
              <div className="flex justify-center gap-4 mb-4">
                ...
                {/* Este botón es para el archivo subido; lo dejamos como estaba */}
              ...
              <p className="text-sm text-gray-500">
                Código: DIRECCIONAMIENTO-ESTRATEGICO-CAR-001 | Versión: 2.0 | Fecha: Marzo 2024
              </p>
            </div>
          )}
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4 mb-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <option>Direcccionamiento Estrátegico</option>
            </select>
          </div>
        </div>
            ...
            <div key={doc.id} className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  {/* Descargar: SOLO si es tipo Formato/Formatos */}
                  {esFormato(doc) ? (
                  ...
                  {/* Si prefieres mostrarlo deshabilitado en vez de ocultarlo, usa este bloque:
                  {!esFormato(doc) && (
                    <button
                      disabled
