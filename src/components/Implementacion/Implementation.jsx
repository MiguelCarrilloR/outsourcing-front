...
export default function StrategicDirectionModule() {
  ...
  const documents = [
    {
      id: 1,
      title: "Procedimiento de Implementación de Proyectos",
      code: "IM-PR-001",
      version: "1.0",
      date: "2025-01-22",
      subprocess: "Implementación",
      type: "Procedimientos",
      tag: "PR",
      color: "bg-red-600"
    },
    {
      id: 2,
      title: "Procedimiento de Gestión de Despliegues (Release Management)",
      code: "IM-PR-002",
      version: "1.1",
      date: "2025-02-08",
      subprocess: "Implementación",
    ...
    {
      id: 3,
      title: "Procedimiento de Gestión de Incidencias Post-Implementación",
      code: "IM-PR-003",
      version: "1.0",
      date: "2025-03-01",
      subprocess: "Implementación",
    ...
    {
      id: 4,
      title: "Formato de Plan de Implementación y Cronograma",
      code: "IM-FO-001",
      version: "1.0",
      date: "2025-02-15",
      subprocess: "Implementación",
    ...
    {
      id: 5,
      title: "Formato de Acta de Puesta en Producción",
      code: "IM-FO-002",
      version: "1.0",
      date: "2025-03-05",
      subprocess: "Implementación",
    ...
    <div className="max-w-7xl mx-auto p-6 bg-white">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Ejecución de proyectos, implementación de soluciones y entrega de servicios a clientes.
        </p>
      </div>
          ...
          {!uploadedPdf ? (
            <div>
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                Caracterización - Proceso de Implementación
              </h3>
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                Código: IM-CAR-001 | Versión: 1.0 | Fecha: 2025-01-20 | Subproceso: Implementación
              </p>
            </div>
          )}
        </div>
