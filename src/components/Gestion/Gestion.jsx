...
export default function StrategicDirectionModule() {
  ...
  const documents = [
    {
      id: 1,
      title: "Procedimiento de Gestión de Oportunidades Comerciales",
      code: "GC-PR-001",
      version: "1.0",
      date: "2025-01-20",
      subprocess: "Gestión Comercial",
      type: "Procedimientos",
      tag: "PR",
      color: "bg-red-600"
    },
    {
      id: 2,
      title: "Procedimiento de Cotización y Negociación",
      code: "GC-PR-002",
      version: "1.1",
      date: "2025-02-10",
      subprocess: "Gestión Comercial",
    ...
    {
      id: 3,
      title: "Procedimiento de Cierre y Onboarding Comercial",
      code: "GC-PR-003",
      version: "1.0",
      date: "2025-03-05",
      subprocess: "Gestión Comercial",
    ...
    {
      id: 4,
      title: "Formato de Registro de Prospectos (Leads)",
      code: "GC-FO-001",
      version: "1.2",
      date: "2025-01-30",
      subprocess: "Gestión Comercial",
    ...
    {
      id: 5,
      title: "Formato de Cotización Comercial",
      code: "GC-FO-002",
      version: "1.0",
      date: "2025-02-22",
      subprocess: "Gestión Comercial",
  ...
  // --- Helpers para comparación robusta ---
    ...
    <div className="max-w-7xl mx-auto p-6 bg-white">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Desarrollo de estrategias comerciales, gestión de clientes y promoción de servicios organizacionales.
        </p>
      </div>
          ...
          {!uploadedPdf ? (
            <div>
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                Caracterización - Proceso de Gestión Comercial
              </h3>
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                Código: GC-CAR-001 | Versión: 1.0 | Fecha: 2025-01-15 | Subproceso: Gestión Comercial
              </p>
            </div>
          )}
        </div>
            ...
            <div key={doc.id} className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  {/* Alternativa deshabilitada (si prefieres mostrarlo grisado):
                  {!esFormato(doc) && (
                    <button
                      disabled
