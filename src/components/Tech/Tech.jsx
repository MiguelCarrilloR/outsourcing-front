...
export default function StrategicDirectionModule() {
  ...
  const documents = [
    {
      id: 1,
      title: "Procedimiento de Desarrollo y Despliegue (CI/CD)",
      code: "IT-PR-001",
      version: "1.0",
      date: "2025-02-12",
      subprocess: "Desarrollo",
      type: "Procedimientos",
      tag: "PR",
      color: "bg-red-600"
    },
    {
      id: 2,
      title: "Procedimiento de Gestión de Incidentes y Mesa de Ayuda (SLA)",
      code: "IT-PR-002",
      version: "1.1",
      date: "2025-02-20",
      subprocess: "Mesa de Ayuda",
      type: "Procedimientos",
      tag: "PR",
      color: "bg-red-600"
    },
    {
      ...
      version: "2.0",
      date: "2025-03-01",
      subprocess: "Seguridad de la Información",
      type: "Políticas",
      tag: "PO",
      color: "bg-red-600"
    },
    {
      id: 4,
      title: "Formato de Requerimientos Técnicos para Preventa/Servicios",
      code: "IT-FO-001",
      version: "1.0",
      date: "2025-02-28",
      subprocess: "Preventa",
    ...
    {
      id: 5,
      title: "Procedimiento de Gestión de Cambios en Infraestructura (CMDB)",
      code: "IT-PR-003",
      version: "1.0",
      date: "2025-03-06",
      subprocess: "Infraestructura",
      type: "Procedimientos",
      tag: "PR",
      color: "bg-red-600"
    }
  ...
  // ---- Helpers para decidir si es formato (tolerante a tildes/mayúsculas) ----
    ...
    <div className="max-w-7xl mx-auto p-6 bg-white">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Gestión integral de la infraestructura tecnológica, sistemas de información y recursos digitales de la organización.
        </p>
      </div>
          ...
          {!uploadedPdf ? (
            <div>
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                Caracterización - Proceso de Tecnología
              </h3>
            ...
            <div>
              ...
              <div className="flex justify-center gap-4 mb-4">
                ...
                {/* Botón de descarga del archivo subido: se mantiene */}
              ...
              <p className="text-sm text-gray-500">
                Código: IT-CAR-001 | Versión: 1.0 | Fecha: 2025-03-15 | Subproceso: Tecnología
              </p>
            </div>
          )}
        </div>
            ...
            <div key={doc.id} className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  {/* Variante deshabilitada (si prefieres mostrarla):
                  {!esFormato(doc) && (
                    <button
                      disabled
