...
export default function StrategicDirectionModule() {
  ...
  const documents = [
    {
      id: 1,
      title: "Política de Innovación y Gestión del Conocimiento",
      code: "GI-PO-001",
      version: "1.0",
      date: "2025-01-15",
      subprocess: "Gestión de Innovación",
      type: "Políticas",
      tag: "PO",
      color: "bg-red-600"
    },
    {
      id: 2,
      title: "Procedimiento para la Gestión del Portafolio de Innovación",
      code: "GI-PR-001",
      version: "1.2",
      date: "2025-02-03",
      subprocess: "Gestión de Innovación",
    ...
    {
      id: 3,
      title: "Manual del Sistema de Innovación (Modelo, roles y gobernanza)",
      code: "GI-MA-001",
      version: "1.0",
      date: "2025-03-01",
      subprocess: "Gestión de Innovación",
    ...
    {
      id: 4,
      title: "Caracterización del Proceso de Gestión de Innovación",
      code: "GI-CA-001",
      version: "1.0",
      date: "2025-01-25",
      subprocess: "Gestión de Innovación",
    ...
    {
      id: 5,
      title: "Formato de Registro y Evaluación de Ideas",
      code: "GI-FO-001",
      version: "1.3",
      date: "2025-02-10",
      subprocess: "Gestión de Innovación",
    ...
    <div className="max-w-7xl mx-auto p-6 bg-white">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Desarrollo e implementación de iniciativas de innovación y mejoramiento organizacional.
        </p>
      </div>
          ...
          {!uploadedPdf ? (
            <div>
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                Caracterización - Proceso de Gestion de Innovación
              </h3>
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                Código: GI-CA-001 | Versión: 1.0 | Fecha: 2025-01-25 | Subproceso: Gestión de Innovación
              </p>
            </div>
          )}
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4 mb-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <option>Gestión de Innovación</option>
            </select>
          </div>
        </div>
