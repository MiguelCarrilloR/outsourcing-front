...
const documents = [
  ...
  },
  {
    ...
    version: "1.0",
    date: "2025-02-20",
    subprocess: "Valoración de la Experiencia y Calidad CXs",
    type: "Procedimientos",
    tag: "PR",
    color: "bg-red-600"
  },
          ...
          {!uploadedPdf ? (
            <div>
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                Caracterización - Proceso de Valoracion de la Experiencia y Calidad CX
              </h3>
            ...
            <div>
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                Caracterización - Proceso de Valoracion de la Experiencia y Calidad CXSeguridad y Salud en el Trabajo (SST)
...
V
              ...
              <p className="text-sm text-gray-500">
                Código: VE-CAR-001 | Versión: 1.0 | Fecha: 2025-03-22 | Subproceso: Valoración de la Experiencia y Calidad CXSeguridad y Salud en el Trabajo (SST)
              </p>
            </div>
          )}
        </div>
